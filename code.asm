...
in_str_fmt:     db "%100s",0

s1: db "Palindrome",0
s2: db "Not palindrome",0
SECTION .bss
str: resb 101         ; allow 100 chars + NUL
arr: resq 100
s: resb 101           ; room for NUL
...
main:                
    ...
    cmp rbx,0
    je np
    lea rsi, [s1]    ;if(rbx!=0) print "Palindrome"
    call print_str
    jmp en
    np:
    lea rsi, [s2]    ;if(rbx==0) print "Not palindrome"
    call print_str
    en:
